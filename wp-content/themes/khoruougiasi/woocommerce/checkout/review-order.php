...
?>
<?php if ( is_checkout() ):?>
	<table class="shop_table woocommerce-checkout-review-order-table table box">
		<tfoot>
			<tr class="cart-title">
				<th colspan="2"><h4 class="title line-default"><?php _e( 'Oder summary', 'woocommerce' ); ?></h4></th>
			</tr>
